...
class TestMoebot(TuyaDeviceTestCase):
    ...
    def test_supported_features(self):
        self.assertEqual(
            ...
            (
                ...
                | LawnMowerEntityFeature.CANCEL
                | LawnMowerEntityFeature.RESUME
    ...
    def test_lawnmower_activity(self):
        ...
        self.assertEqual(self.mower.activity, LawnMowerActivity.EMERGENCY)
        self.dps[STATUS_DP] = "PAUSED"
        self.assertEqual(self.mower.activity, LawnMowerActivity.PAUSED)
        self.dps[STATUS_DP] = "PARK"
        self.assertEqual(self.mower.activity, LawnMowerActivity.PARK)
        ...
        self.assertEqual(self.mower.activity, LawnMowerActivity.STANDBY)
        self.dps[STATUS_DP] = "CHARGING"
        self.assertEqual(self.mower.activity, LawnMowerActivity.CHARGING)
        self.dps[STATUS_DP] = "LOCKED"
        self.assertEqual(self.mower.activity, LawnMowerActivity.LOCKED)
        self.dps[STATUS_DP] = "CHARGING_WITH_TASK_SUSPEND"
        self.assertEqual(self.mower.activity, LawnMowerActivity.CHARGING_WITH_TASK_SUSPEND)
